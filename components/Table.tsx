        ...
        >
          ...
          <td className="text-center flex justify-around items-center phone:flex-wrap phone:w-full phone:justify-start phone:mr-1">
            <button
              ...
              onClick={() => {
                route.push(`/products/${itemPro.id}`);
              }}
            >
              View
            </button>
            <button className="bg-green-500  hover:bg-green-300 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded-lg mr-5 phone:w-32 phone:text-start">
              Add
            </button>
            <button
